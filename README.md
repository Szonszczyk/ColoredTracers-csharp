...
Better description, download count and comments can be found on: [SPT Forge Link](https://forge.sp-tarkov.com/mod/2037/colored-tracers)

Server mod for Single Player Tarkov (SPT) adding colored tracers to every ammo in the game\
